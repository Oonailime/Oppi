...
- **Global scope**: `/mnt/c/Users/T-GAMER/Desktop/aleatorio/dataprev/.codex/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/mnt/c/Users/T-GAMER/Desktop/aleatorio/dataprev/.codex/notes/`)
...
2. Glob `/mnt/c/Users/T-GAMER/Desktop/aleatorio/dataprev/.codex/notes/*.md` (if directory exists) — global notes
...
Global (/mnt/c/Users/T-GAMER/Desktop/aleatorio/dataprev/.codex/notes/):
...
2. **No `.planning/`**: Falls back to global `/mnt/c/Users/T-GAMER/Desktop/aleatorio/dataprev/.codex/notes/` — works in any directory
